          ...
          <CardContent className="pt-0 pb-12">
            ...
            <div>
              <div className="flex md:hidden w-full justify-center gap-6 mt-6">
                ...
                <a href="https://t.me/squalo" target="_blank" rel="noopener noreferrer" aria-label="Telegram" className="w-12 h-12 rounded-full bg-shark-light/10 flex items-center justify-center">
