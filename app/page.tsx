              ...
              <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.45 }}>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-4 items-stretch auto-rows-fr">
                  {[
                    ...
                    { title: "Agenti", description: "This project was created to offer a simple service that allows users without a verified Fragment account to fully interact with the platform. Through it, anyone can buy or bid on NFTs, mint usernames or gifts, and complete every action by paying a small service fee. It is easy and convenient to use.", imgSrc: "/agenti.jpg", href: "https://t.me/agenti" },
                  ].map((p, idx) => (
