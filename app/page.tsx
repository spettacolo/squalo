                ...
                <div className="rounded-md bg-shark-light/5 px-3 py-4 sm:p-6">
                  ...
                  <div>
                    ...
                    <div className="hidden md:block">
                      ...
                      I'm a <b>developer</b> who wears many hats, always eager to learn and build. While my main gig is <b>programming</b> — <span style={{ color: '#6d8dc1ff' }}>crafting code and developing applications</span> — I also have a keen eye for detail, which I exercise through image editing. And when I need to unwind, you can bet I'm listening to music of all kinds! Beyond just listening, I also love to play: I'm currently learning to play the guitar, and I have previous experience with 4 years of violin, plus some basic knowledge of piano and drums.
                      </p>
                    </div>
