              ...
              <div className="flex flex-wrap gap-3">
                ...
                <Button asChild className="bg-shark-light/10 px-3 py-2 text-sm">
                  <a href="https://t.me/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
                    {/* Official Telegram circular logo provided by user, adapted to currentColor */}
                    <svg className="w-4 h-4" viewBox="0 0 32 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden>
