                  ...
                  <div>
                    ...
                    <div className="md:hidden">
                      ...
                      <summary className="list-none cursor-pointer">
                        ...
                        >
                          I'm a <span className="keys"><b>developer</b></span> who wears many hats, always eager to learn and build. <br /><br />While my main gig is <span className="keys"><b>programming</b></span> — <span className="notes"><i>crafting code and developing applications</i></span> — I also have a keen eye for detail, which I exercise through <span className="keys"><b>image editing</b></span>. <br /><br />And when I need to unwind, you can bet I'm <i>listening to music</i> of all kinds! Beyond just listening, I also love to play: I'm currently learning to play the <span className="keys"><b>guitar</b></span>, and I have previous experience with 4 years of <span className="keys"><b>violin</b></span>, plus some basic knowledge of <span className="notes"><i>piano</i></span> and <span className="notes"><i>drums</i></span>.
                        </div>
