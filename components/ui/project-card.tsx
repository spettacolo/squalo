...
export default function ProjectCard({ title, description = "Coming soon", imgSrc, href }: Props) {
  return (
    <motion.div initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.28 }} className="rounded-lg bg-shark-light/6 p-3 flex flex-col items-start gap-3 h-full">
      ...
      <div className="w-full flex-1 min-h-0">
        ...
        <div className="text-xs text-shark-sand/70 mt-1 break-words">{description}</div>
      </div>
