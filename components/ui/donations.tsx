            ...
            <div className="w-64 text-left flex items-center">
              {e.href ? (
                <a
                  ...
                  className="donation-address donation-clickable underline-offset-2 hover:underline inline-flex items-center"
                >
                ...
                <motion.span
                  ...
                  className="donation-address donation-copyable cursor-pointer select-none inline-flex items-center w-full text-left"
